...
/**
 * Orchestrates the generation of town populations using demographics configuration.
 * This generator creates students and staff independently of schools, allowing for
