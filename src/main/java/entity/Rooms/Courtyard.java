...
public class Courtyard implements Room, Serializable {
    ...
    public void setSeatArrangement() {
        ...
        if (studentCap <= 36) {
            ...
            if (choice == 0) {
                seats = new Student[9][9];
            } else if (choice == 1) {
                seats = new Student[9][10];
            } else {
                seats = new Student[10][9];
            }
        } else if (studentCap <= 169) {
            if (choice == 0) {
                seats = new Student[13][13];
            } else if (choice == 1) {
                seats = new Student[10][17];
            } else {
                seats = new Student[17][10];
            }
        } else {
